...
Repositório do grupo de estudos sobre Swift do [Training Center](https://training-center.github.io).
...
Este grupo se destina ao estudo de Swift.
...
Basta responder [este formulário]() para sabermos seu nível de conhecimento, entrar no [Slack do Training Center](https://github.com/training-center/slack) e entrar no canal **#swift-studies**.
...
Caso você precise entrar em contato com as pessoas responsáveis por este grupo de estudos, pode chamar por `@amadeu01` no Slack do Training Center.
